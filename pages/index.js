                        ...
                        <section class="pricing-ds section-padding">
                            <div class="container">
                                    ...
                                    <div class="content">
                                        <div class="price-head">
                                            ...
                                            <div class="price-headItem">
                                                <h6>basic</h6>
                                                <h2 class="monthly_price">
                                                    $3,999 <span>/mo</span>
                                                </h2>
                                                <h2 class="yearly_price">
                                                    $3,999 <span>/yr</span>
                                                </h2>
                                                <p>
                                            ...
                                            <div class="price-headItem bg-gray">
                                                <h6>Premium</h6>
                                                <h2 class="monthly_price color-blue5">
                                                    $6,499 <span>/mo</span>
                                                </h2>
                                                <h2 class="yearly_price color-blue5">
                                                    $6,499 <span>/yr</span>
                                                </h2>
                                                <p>
                                                    Perfect for medium or <br />{" "}
                                                    big business
                                                </p>
                                                {/* <div class="label">
                                                    <img
                                                        src="assets/imgs/pricing/Label.svg"
                                                        alt=""
                                                    />
                                                </div> */}
                                            </div>
                                        ...
                                        <div class="price-body">
                                            ...
                                            <div class="price-bodyItems">
                                                ...
                                                <div class="price-item"></div>
                                                <div class="price-item bg-gray"></div>
                                                <div class="price-item">
                                                    <i class="fa-solid fa-check"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="price-foot">
                                            ...
                                            <div class="price-foot-item bg-gray">
                                                <a
                                                    href="#0"
                                                    class="butn butn-md butn-bg butn-rounded"
                                                >
                                                    <div class="d-flex align-items-center">
                                                        <span>
                                                            Pick This Package
                                ...
                                <div class="botm mt-70">
                                    <span>
                                        Not find your plan! Want to setup a
                                        tailor-plan for only you?{" "}
